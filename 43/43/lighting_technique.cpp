...
bool LightingTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:/Users/kmlll/source/repos/43/43/shaders6_5/lighting.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "C:/Users/kmlll/source/repos/43/43/shaders6_5/lighting.fs")) {
        return false;
    }

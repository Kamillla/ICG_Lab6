...
bool ShadowMapTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:/Users/kmlll/source/repos/43/43/shaders6_5/shadow_map.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "C:/Users/kmlll/source/repos/43/43/shaders6_5/shadow_map.fs")) {
        return false;
    }
